...
function CardsSearch(props) {
    if (!props.data[0]) {
        return (
            <div className="loading-container">
                <h3 className="sect-title">Please Select Desired Country<br />to Review Results.</h3>
            </div>
        )
    }
    return (
    ...
    <h3 className="sect-title">Current Condition of the {props.title}</h3>
                ...
                <div className="linegraph-container">
                    <h3 className="sect-title">Graphical Representation the Victims of Corona Virus</h3>
