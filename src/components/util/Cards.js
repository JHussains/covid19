...
function Cards(props) {
    if (!props.data[0]) {
        return (
            <div className="loading-container">
                <h3 className="sect-title">Current Situation Around the Globe</h3>
    ...
    <h3 className="sect-title">Current Situation Around the {props.title}</h3>

                <Grid container justify="center">
                    <Grid item xs={12} md={3} component={Card} className="card card-infected">
                        <CardContent>
                            <Typography color="textSecondary" className="card-heading" gutterBottom>Active Cases</Typography>
                    ...
                    <Grid item xs={12} md={3} component={Card} className="card card-infected">
                        ...
                        <CardContent>
                            <Typography color="textSecondary" className="card-heading" gutterBottom>Total Death Cases</Typography>
                ...
                <div className="graph-container">
                    <h3 className="sect-title">Graphical Representation Victim of Covid-19</h3>
                    <Graphs data={props.data[0]} convertNum={props.changeNum} title={props.title} />
                </div>
            </div>
        </React.Fragment>
